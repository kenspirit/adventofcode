...
defmodule Lanternfish do
  defp grow(states, 0) do
    length(states)
  end

  defp grow(states, days_after) do
    # IO.puts("---- After #{18 - days_after} days ----")
    # IO.inspect(states)
    count_with_zero = Enum.count(states, fn state -> state == 0 end)
    ...
    grow(current_states ++ Enum.map(1..count_with_zero//1, fn _ -> 8 end), days_after - 1)
  end

  def growth_pattern(initial_state, days_after) do
    grow(initial_state, days_after)
  end
end
